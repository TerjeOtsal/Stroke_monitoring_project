...
class1_df = pd.read_csv('Class1 (2).csv')
class2_df = pd.read_csv('Class2 (2).csv')
class3_df = pd.read_csv('Class3 (2).csv')
class4_df = pd.read_csv('Class4 (2).csv')
class5_df = pd.read_csv('Class5-1.csv')
...
labeled_data.to_csv('combined_labeled_stroke_data2.csv', index=False)
