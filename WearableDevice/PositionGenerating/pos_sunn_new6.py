...
for i in range(1, len(data)):
    ...
    # Check if the translation vector length exceeds 1 meter
    distance = np.linalg.norm(translation)
    if distance > 1.0:
        # Scale the vector to have a maximum length of 1 meter
        translation = (translation / distance) * 1.0
...
# Save the new translations with maximum length of 1 meter to a CSV file
...
ax.legend()
plt.title("3D Translation Vectors from Reference Point with Maximum Length Constraint")
